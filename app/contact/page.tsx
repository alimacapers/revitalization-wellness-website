...
export default function ContactPage() {
  return (
    <main>
      ...
      <section className="contact-intro"><p className="pretitle">Alexandria, Virginia</p><h2>Serving communities across Northern Virginia</h2><p>Call <a href="tel:+19176879317"><strong>(917) 687-9317</strong></a> or visit us at <strong>2121 Eisenhower Avenue, Suite 219, Alexandria, Virginia 22314</strong>.</p><ul className="area-pills"><li>Alexandria</li><li>Fairfax</li><li>Springfield</li><li>McLean</li><li>Burke</li><li>Tysons Corner</li></ul></section>
